...
class QAConfigEdit extends Component {
    ...
    componentDidMount() {
        ...
        alert("id="+id)
         ...
         axios
        .get("http://127.0.0.1:8000/api/qaconfigs/"+id+"/")
    ...
    handleSubmit = (event) => {
        ...
        //alert(this.state.qaconnid);
        var id = (new URLSearchParams(window.location.search)).get("id");
            var apiBaseUrl = "http://127.0.0.1:8000/api/qaconfigs/"+id+"/";
            var self = this;
            var payload={
            ...
            .then(res => this.goToConfigDetailsPage())
        ...
        return (
            ...
            <table>
                ...
                <td>
                    ...
                    <select id="systype" defaultValue={this.state.systemtype} onChange={this.systemtypehandler} >
                ...
                <td>
                    ...
                    <select id="triggeruom" defaultValue={this.state.triggeruom} onChange={this.triggeruomhandler} >
                    <option value="">Select</option>
    ...
    fillForm = (data) => {
        ...
        document.getElementById('systype').value = data.systemtype;
        document.getElementById('triggeruom').value = data.triggeruom;
